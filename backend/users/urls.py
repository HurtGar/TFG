...
from users.views import viewsUser
...
urlpatterns = [
    ...
    path('create-user', viewsUser.CreateUser.as_view(), name='usuario_state'),
    path('update/<int:user_id>', viewsUser.UpdateUser.as_view(), name='modificar_usuario'),
    path('delete/<int:user_id>', viewsUser.DeleteUser.as_view(), name='borrar_usuario'),
